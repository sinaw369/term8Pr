...
func GetDashBoardContent(ctx *context.Context) (types.Panel, error) {
	...
	boxInfo := components.Box().
		...
		SetHeadColor("#f7f7f7").
		SetBody(table).
		SetFooter(`<div class="clearfix"><a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">processAnOrder</a><a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">ViewAllNewOrders</a> </div>`).
		GetContent()
